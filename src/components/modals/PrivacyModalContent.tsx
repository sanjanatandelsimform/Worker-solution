    ...
    <div className="w-full h-120 overflow-y-scroll pl-4 pb-6 pr-4">
      <div className="space-y-4">
        ...
        <p className={cls.body}>
          ...
          Lafayette Square Institute and herein referred to as "Lafayette Square," "we," "us," or
          "our") is committed to respecting privacy and protecting personal information. Your
          privacy is very important to us. This Privacy Notice (the "Notice") describes how we
        ...
        <p className={cls.body}>
          ...
          you visit our Site, as a user of A2B, including the types of information that we collect
          from you in connection with your use of the Site, and how that information will be used,
          including Personal Information (as defined below).
        </p>
        <p className={cls.body}>
          Please read this Notice carefully to understand our views and practices regarding your
          personal information and how we will treat it. Please also read our Terms of Use, which
          govern access to and use of A2B; the Terms of Use are available on our website, or you can
          download a PDF version of the Terms of Use here [INSERT HYPERLINK TO TERMS OF USE PDF].
        </p>
        <p className={cls.body}>
          We reserve the right, at our discretion, to change our Privacy Notice at any time without
          prior notice. When we do, we will post the revised Notice on this page with a new "Last
          Updated" date. The revised Notice will become effective at the time of posting. We suggest
          that you review this Notice periodically for changes.
        </p>
        <p className={cls.body}>
        ...
        <p className={cls.body}>
          ...
          including any third-party apps or websites (including third-party websites you may access
          through A2B). We encourage you to review the privacy policies of any business you interact
          with.
        </p>
        <p className={cls.body}>
          This Notice also does not apply to workforce members, such as job applicants, employees,
          retirees, or contractors.
        </p>

        {/* Table of Contents */}
        <div className="space-y-1">
          <p className={cls.body}>
            This Notice is provided in a layered format so you can navigate to the specific areas
            set out below:
          </p>
        ...
        <div className="space-y-2">
          <p className={cls.sectionHeading}>1. The Types of Personal Information We Collect</p>
          <p className={cls.body}>
            For purposes of this Notice, "Personal Information" generally means information that
            identifies, relates to, describes, is reasonably capable of being associated with, or
            could reasonably be linked, directly or indirectly, with a particular person or
            household, such as name, email address or phone number, account number or account
            information. Personal Information does not include publicly available information or
            information that is deidentified or anonymized consistent with applicable privacy laws.
          </p>
          <p className={cls.body}>
            We collect personal information from a number of sources in circumstances including, but
          ...
          <p className={cls.body}>
            If you choose to not provide us with this or other personal information, you might not
            be able to access certain information and services on A2B or the Site.
          </p>
          <p className={cls.body}>
          ...
          <p className={cls.body}>
            If you have signed up for, or are otherwise receiving for reasons permitted by law, our
            notifications, you may at any time unsubscribe or opt-out from receiving them by
            contacting us or following any provided unsubscribe or opt-out options.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            require us to provide additional disclosures with respect to our collection, use, and
            disclosure of personal data. The information in this section is provided as a supplement
            to the rest of the information provided in this Notice. Please read the entire Notice
            for a full description of our privacy practices.
          </p>
          <p className={cls.body}>
            We do not sell or share Personal Information for cross-context behavioral advertising,
            nor have we done so in the past twelve months.
          </p>
          <p className={cls.body}>
            The Personal Information we collect includes information within the below categories of
            data. Note that the "category of data" column listed below refers to the category of
            personal data as defined under California law and represents the categories of personal
            information that we have collected, and how it has been shared, over the past twelve
            (12) months, if applicable. Inclusion of a category in the list below indicates only
            that we may collect some information within that category. We do not necessarily collect
            all information listed in a particular category, nor do we necessarily collect all
            categories of information for all individuals. While the categories are defined under
            California law, the disclosures below also apply to residents of other states as well.
          </p>
          <p className={cls.body}>
            We may disclose personal information in each of the below categories with our affiliates
            and service providers, as well as with government entities as necessary, for our
            business purposes.
          </p>
                ...
                {[
                  ...
                  <tr key={row.category} className="align-top">
                    <td className="border border-ws-border-primary px-3 py-2 text-xs text-ws-text-secondary leading-relaxed">
                      <span className="font-semibold text-ws-text-primary">{row.category}</span>{" "}
                      {row.description}
                    </td>
                    <td className="border border-ws-border-primary px-3 py-2 text-xs text-ws-text-secondary leading-relaxed">
                      {row.source}
          ...
          <p className="text-sm font-semibold text-ws-text-primary mt-4">Sensitive Personal Data</p>
          <p className={cls.body}>
            In addition to the categories of personal data above, we may collect the following
            categories of sensitive personal data. We only process your sensitive personal data for
            purposes considered necessary under applicable law.
          </p>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Sometimes we engage companies that act on our behalf in connection with the operation of
            A2B and the Site. For example, such companies may deliver products or services, improve
            the functionality of A2B and the Site, collect information about you, communicate with
            you, or store information for us. In some cases, these companies may need to access
            information about you. We endeavor to require our service providers by contract to
            collect, store, and use information about you only on our behalf, and in accordance with
            the provisions of this Notice.
          </p>
          <p className="text-sm font-semibold text-ws-text-primary">Analytics Providers</p>
          <p className={cls.body}>
            We may engage third-party analytics providers to help us understand how users engage
            with A2B and the Site. These third parties may use cookies and similar technologies to
            collect information about your use of A2B and the Site.
          </p>
          ...
          <p className={cls.body}>
            ...
            affiliates for use to support our business and who will use it only for the purposes for
            which we disclose it to them. Lafayette Square may also share your personal information
            with non-affiliates such as, but not necessarily limited to, third-party service
            providers, law enforcement or regulatory authorities, our auditors, legal, and other
            professional advisors, accounting and billing providers, mailing and printing services,
            and other service providers who will use it only for the purposes for which we disclose
            it to them, which may include for the purpose of technology and software, payment
            processing and tracking, and to otherwise support our business and to provide you with
            services.
          </p>
          <p className={cls.body}>
            We may also share your information with selected recipients for the following purposes:
          </p>
          <ul className={cls.bulletList}>
            <li className={cls.body}>
              To process and store data, including your Personal Information; to track, analyze, and
              modify A2B or the Site; for marketing, advertising, and distribution; for
              co-sponsoring or co-branding certain services, promotions, or events; to assist us in
              providing you with customer support; and to support our IT and security efforts.
            </li>
            <li className={cls.body}>
              We may share your information with our affiliates and subsidiaries, and may also
              provide information to our attorneys, banks, auditors, and other service providers.
            </li>
          </ul>
          <p className="text-sm font-semibold text-ws-text-primary">Other Sharing Practices</p>
          ...
          <p className={cls.body}>
            We may also share such information in connection with any potential or actual merger or
            acquisition. We may also share information about you to the extent reasonably necessary
            to proceed with the consideration, negotiation, or completion of a merger,
            reorganization, or acquisition of our business, or a sale, liquidation, or transfer of
            some or all of our assets.
          </p>
          <p className={cls.body}>
            We do not sell personal information or compile reports using it to any third parties. We
            are not a consumer reporting agency.
          </p>
          <p className={cls.body}>
            This includes exchanging information with other companies and organizations for the
            purposes of fraud detection, protection and credit risk reduction, including any
            information that may be used and disclosed pursuant to the Fair Credit Reporting Act and
            its Red Flags Rule. We will take reasonably necessary steps to ensure that where
            personal information is shared, it is treated securely and in accordance with this
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            We consider the following criteria when determining how long a particular record will be
            retained, including any personal information contained in that record:
          </p>
          <ul className={cls.bulletList}>
            {[
          ...
          <p className={cls.body}>
            The same personal information about you may be included in more than one record and used
            for more than one purpose, each of which may be subject to different retention periods
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            rights with respect to Personal Information about you. We may, at our discretion, choose
            to extend these rights to you even if we are not required to under applicable law.
          </p>
          {[
            {
          ...
          <p className={cls.body}>
            We do not discriminate against you if you choose to exercise any of these rights. If we
            deny your request, you may also have the right to appeal that decision. Instructions on
            how to appeal any denial will be included in the notice of denial.
          </p>
          <p className={cls.body}>
          ...
          <p className={cls.body}>
            ...
            these rights until it is restored to an active system or next accessed or used for a
          ...
          <p className={cls.body}>
            <span className={cls.inlineLabel}>
              Additional Information for Residents of Colorado and California (to the extent those
              laws apply):
            </span>{" "}
          ...
          <p className={cls.body}>
            ...
            information that we have disclosed to a third party for their direct marketing purposes
            during the preceding year and to whom that information was disclosed.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            You can exercise your privacy rights by submitting requests to us and by taking other
            steps that will limit how information about you is collected, used, and shared.
          </p>
          <p className={cls.body}>
          ...
          <p className={cls.body}>
            ...
            satisfy your request. For deletion requests, you will be required to submit a verifiable
            request for deletion and then confirm separately that you want personal information
            about you deleted.
          </p>
          <p className={cls.body}>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Like most website operators, we gather technical usage information that web browsers,
            depending on their settings, make available. As we want to be responsive to you and to
            ensure the proper functioning of our products and organization, we may use the
          ...
          <p className={cls.body}>
            Cookies are small text files placed on your device by your browser. Cookies allow us to
            recognize your browser, remember your preferences, keep you signed in, and understand
            how you use A2B. They may be set by us (first-party cookies) or by others (third-party
            cookies, such as for analytics or advertising).
          </p>
          <p className={cls.body}>
          ...
          <p className={cls.body}>
            ...
            required to render certain forms, such as email list sign-up, or to allow for some
            advertising outside of A2B. Session cookies are temporary cookies that are used to
            remember you during the course of your visit to A2B, and they expire when you close the
            web browser.
          </p>
          <p className={cls.body}>
            Persistent cookies are used to remember your preferences within A2B and remain on your
            desktop or mobile device even after you close your browser or restart your computer. We
            use these cookies to analyze user behavior to establish visit patterns so that we can
            improve A2B functionality for you and others who visit.
          </p>
          <p className="text-sm font-semibold text-ws-text-primary">
            How Do I Reject and Delete Cookies?
          </p>
          <p className={cls.body}>
            You can choose to reject or block all or specific types of cookies for A2B by changing
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Various third parties are developing ways for consumers to express their choice about
            the collection of the individual consumer&rsquo;s online activities over time and across
            third-party websites or online services. We typically only use essential cookies.
            However, if we choose to employ third-party cookies for analytical or marketing
            purposes, we will prompt you to select your choices for non-essential cookies when you
            first visit A2B. We have tools in place to better detect and honor requests made using
            the Global Privacy Control (&ldquo;GPC&rdquo;) signal as requests to opt out of the
            sharing of Personal Information to the extent required by applicable law and to the
            extent we employ third-party cookies.
          </p>
        </div>
        ...
        <div id="privacy-section-9" className="space-y-2">
          ...
          <p className={cls.body}>
            The security and confidentiality of the information we collect or receive is extremely
            important to us, and we take our responsibility to protect this information very
            seriously. We have implemented commercially reasonable technical, administrative, and
            physical security measures to protect the information that we collect or receive.
          </p>
          <p className={cls.body}>
            From time to time, we review and consider updates for our security procedures. Please be
            aware, though that, despite our ongoing efforts, no security measures are perfect or
            impenetrable. This means that we cannot ensure or warrant the security of any
            information we collect about you, and therefore your use of A2B and the Site is at your
            own risk.
          </p>
          <p className={cls.body}>
            The safety and security of your information also depends on you. Where we have given you
            (or where you have chosen) a password for access to certain parts of A2B, you are
            responsible for keeping this password confidential. We ask you not to share your
            password with anyone. Unfortunately, the transmission of information via the internet is
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            websites whose privacy practices may be different from ours. If you submit personal
            information to any of those sites, your information is governed by their privacy
            policies. We encourage you to carefully read the privacy policy of any website you
            visit.
          </p>
          <p className={cls.body}>
            We may link the information that we collect automatically with the information you
            provide us. And we may combine the information we collect online with information we
            collect offline or that is collected by third parties.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            communications that you have requested (including information about corporate events,
            press releases, presentations and company documents). You can opt-out of receiving such
            communications at any time by contacting us or by clicking &ldquo;unsubscribe&rdquo; in
            the email.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            A2B is not targeted at children or anyone under the age of eighteen (18). We will delete
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            It is our policy to post any changes we make to this Notice on this page. The date this
            Notice was last revised is identified at the beginning of this Notice. You are
            responsible for ensuring we have an up-to-date active and deliverable email address for
            you, and for periodically visiting A2B and this Notice to check for any changes.
          </p>
        </div>
