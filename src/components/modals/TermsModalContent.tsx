    ...
    <div className="w-full h-120 overflow-y-scroll pl-4 pb-6 pr-4">
      <div className="space-y-4">
        ...
        <p className={cls.body}>
          The following terms and conditions, together with any documents incorporated by reference
          (collectively, the "Terms of Use"), govern your access to and use of the Lafayette Square
          Access2Benefits platform, a workforce analytics platform, including any questionnaires,
          dashboards, reports, content, functionality, and services offered through the platform
          ("A2B"). The effective date of your agreement to these Terms of Use shall be deemed to be
          the date of your first login to A2B. Please read these Terms of Use carefully before using
          A2B. Your access to and use of A2B is subject to these Terms of Use and all applicable
        ...
        <p className={cls.body}>
          ...
          Institute and referred to in these Terms of Use as "Lafayette Square," "we," "us," or
          "our"). A2B is available only to individuals who can form legally binding contracts under
          applicable law and is not intended for use by individuals under the age of 18.
        </p>
        <p className={cls.body}>
          By accessing, using, or visiting A2B, you agree to be bound by these Terms, and further
          agree that you are responsible for compliance with any applicable laws and regulations,
          including any local laws. If you accept these Terms of Use on behalf of an organization,
          you represent that you have the authority to bind that organization. If you do not agree
          with any of these Terms of Use, in whole or in part, you should stop using A2B
          immediately. These Terms apply exclusively to your use of A2B and do not alter the terms
          or conditions of any other agreement you may have with Lafayette Square.
        </p>
        <p className={cls.arbitrationNotice}>
          Please note the arbitration provision below, which may require you to arbitrate claims
          against Lafayette Square on an individual basis and limit your right to a judge, jury, or
          class action.
        </p>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            We may update these Terms of Use based on changes to A2B and other factors. Lafayette
            Square has the right, in its sole discretion, to add to, remove, modify, update, or
            otherwise change any part of these Terms of Use, in whole or in part, at any time. Any
            changes, modifications, or updates made to the Terms of Use go into effect once they are
            posted. We will notify you of changes to these Terms of Use via our website or other
            reasonable means and change the "Last Updated" date above, as applicable. Your continued
            use of A2B following the posting of revised Terms of Use constitutes your acceptance of
            any changes made to these Terms of Use, and by using A2B, you are agreeing to be bound
            by the then-current version of these Terms of Use. If you do not agree to the new terms,
            you should stop using A2B. Any revised terms and conditions and disclaimers shall
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Lafayette Square hereby grants you a non-exclusive, non-transferable, revocable, and
            limited license to access and use A2B solely for internal, non-commercial,
            informational, research, and educational purposes, subject to your continued compliance
          ...
          <p className={cls.body}>
            In addition, you agree that you are solely responsible for actions or communications
            undertaken in the course of your usage of A2B and that you will comply with all laws
            that apply or may apply to your use of or activities on A2B. Lafayette Square will
            investigate occurrences which may involve violations of such laws, and may involve, and
            cooperate with, law enforcement authorities in prosecuting users who are involved in
            such violations. Lafayette Square reserves the right at all times to disclose any
            information transmitted by your using A2B as necessary to satisfy any law, regulation,
            or governmental request. This license may be terminated by Lafayette Square at any time
            in its sole discretion and shall automatically terminate if you violate any of these
            restrictions. Any rights not expressly granted are reserved by Lafayette Square.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            maintaining the confidentiality of your credentials and for all activity occurring under
            your account. If you use a username, password, or any other piece of information in
            order to access any part of A2B, you must treat such information as confidential and you
            must not disclose it to any other person or entity. To the extent you access or connect
            to A2B through Finch or any other third-party integration or connectivity service, you
            represent and warrant that you have been duly authorized by your employer or
            organization to establish such connection and to transmit any data in connection
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            A2B is not targeted at children or anyone under the age of eighteen (18). We do not
            knowingly gather or solicit personal information from children under the age of eighteen
            (18) through A2B for marketing or other purposes. If we determine that personal
            information has been collected from a child under the age of thirteen (13), we will
            delete such information promptly. If you are a parent or guardian of a child under
            thirteen (13) and believe that child has disclosed personal information to us through
            A2B, please contact us using the information in Section 20 (Contact Us) below. By using
            A2B, you represent that you are at least eighteen (18) years of age.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            As a condition of use, you represent and warrant that all information you submit through
            A2B (including, without limitation, workforce, compensation, and benefits data ("User
            Data")) is truthful, accurate, complete, and submitted with proper authorization.
          </p>
          <p className={cls.body}>
            You further represent that your submission of User Data complies with any and all
            applicable laws, and you further acknowledge and agree that you are responsible for
            compliance with all applicable laws, confidentiality obligations, and internal
            organizational policies regarding such User Data. You acknowledge that User Data you
            submit may contain Personal Information (as defined in the Privacy Notice). To the
            extent User Data constitutes or contains Personal Information, Lafayette Square's
            collection, use, and disclosure of such Personal Information is governed by the Privacy
            Notice, which is incorporated into these Terms of Use by reference in Section 10
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            therein, for the following purposes, as more fully described in the Privacy Notice:
          </p>
          <ul className={cls.bulletList}>
            {[
          ...
          <p className={cls.body}>
            Lafayette Square may aggregate and anonymize User Data such that it cannot reasonably
            identify you or your organization. Aggregated and anonymized data may be used for
            benchmarking, research, publications, and educational materials.
          </p>
          <p className={cls.body}>
            Lafayette Square does not sell personal information or compile reports using personal
            information for sale to any third parties. For the avoidance of doubt, the sharing of
            Personal Information described in the Privacy Notice (including with service providers,
            affiliates, and government entities as required by law) does not constitute a "sale" for
            purposes of these Terms of Use.
          </p>
          <p className={cls.body}>
            For a complete description of how we collect, use, and disclose your Personal
            Information, including User Data that constitutes Personal Information, please refer to
            our{" "}
            <Button
              color="link"
              size="sm"
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            A2B and all content therein, including text, graphics, charts, dashboards, software,
            data compilations, and logos ("Content"), are the property of Lafayette Square or its
            licensors and are protected by U.S. and international intellectual property laws. The
            Content also features registered and non-registered trademarks that are protected by
            applicable trademark laws. Lafayette Square and its licensors retain all proprietary
            rights to the Content. You may only use the Content to access information, use A2B, and
            for other uses consistent with these Terms of Use. The Content may not be reproduced,
            transmitted, or distributed without the prior written consent of Lafayette Square. You
            may not use any Content for commercial purposes without Lafayette Square's prior written
            consent.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            provides general workforce and benefits insights for informational and educational
            purposes only. Nothing on A2B constitutes legal, financial, tax, actuarial, or benefits
            advice, and no content, output, recommendation, or suggestion generated by or through
            A2B should be relied upon as such. Any recommendations, suggestions, or insights
            provided by A2B are for informational purposes only and do not constitute professional
            advice of any kind. You acknowledge and agree that you are solely responsible for
            evaluating and making any decisions based on any recommendations, suggestions, insights,
            or other information provided through A2B, and Lafayette Square expressly disclaims any
            and all liability and responsibility for any actions taken or not taken by you in
          ...
          <p className={cls.body}>
            ...
            made that A2B or any part or function thereof will be available and not subject to
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Any information you provide, and that Lafayette Square collects, including via A2B, is
            subject to our Privacy Notice at the{" "}
            <Button
              color="link"
              size="sm"
              onClick={() => {
            ...
            <span className="uppercase">
              Notice regarding consent to data collection and use: By accessing or using A2B, you
              hereby expressly consent to Lafayette Square and its representatives collecting,
              using, and disclosing your personal information — including identifiers, contact
              information, demographic information, internet activity information, device and
              location information, account information, and any other categories of personal
              information described in the Privacy Notice — in the manner described in the Privacy
              Notice.
            </span>{" "}
            You should review the Privacy Notice carefully before using A2B. Your continued use of
            A2B constitutes your ongoing consent to the data practices described in the Privacy
            Notice, as amended from time to time.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Linking to A2B from a Third-Party Site indicates that you accept these Terms of Use and
            that you will abide by the guidelines below. By linking to A2B, you agree that you will
            not:
          </p>
          <ul className={cls.bulletList}>
            {[
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Lafayette Square maintains a policy not to accept any ideas from the public in order to
            avoid possible future confusion between such publicly submitted ideas and ideas of our
            own and also to avoid restriction of our own original research and development
            activities. Notwithstanding the foregoing request, you hereby grant to Lafayette Square
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            Lafayette Square reserves the right to modify, suspend, or terminate A2B or your access
            to it at any time, with or without notice, at Lafayette Square's sole discretion, for
            any reason whatsoever and without limitation, including but not limited to a breach of
            these Terms of Use. All provisions of these Terms of Use which by their nature should
            survive termination shall survive termination, including, without limitation, provisions
            regarding ownership, warranty disclaimers, termination, indemnity, limitation of
            liability, governing law, and those falling under the "Miscellaneous" heading.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            By using A2B, you agree to indemnify, hold harmless, and, at Lafayette Square's request,
            defend Lafayette Square and its officers, directors, members, managers, employees,
            agents, affiliates, licensors, successors, and assigns from and against any and all
            claims, damages, obligations, losses, liabilities, and all costs, debts, and expenses of
            defense, including but not limited to, reasonable attorneys' fees and costs, resulting
            directly or indirectly from or arising out of: (i) any User Data or personal data you
            provide to A2B; (ii) any violation of these Terms of Use; (iii) your use and access of
            A2B, Content, or third-party materials; or (iv) any other claim by a third party that is
            based on your use of A2B in violation of these Terms of Use, in each case, except to the
            extent such claim, demand, damage, loss, liability, or expense arises from our sole
            negligence.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            State of Delaware, United States, without regard to its conflicts of law provisions.
            Subject to Section 17 below, any legal suit, action, or proceeding arising out of or
            related to these Terms of Use or A2B that is not subject to or cannot be resolved by
          ...
          <p className={cls.bodyUpper}>
            ...
            arising out of or relating to these Terms of Use or A2B must be commenced within one (1)
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            rights, you may request that such Content be removed or that access to such Content be
            blocked. All such notices shall be sent to Lafayette Square at the address in the
            "Contact Us" section below. Please provide us with sufficient contact information so
            that we may contact you if necessary to address your notice. Any personal information
            you provide in the notice shall be used solely for the purpose of addressing your
            request for removal.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className={cls.body}>
            ...
            character that would make it difficult to assess the monetary damages resulting from any
            unauthorized use and that unauthorized use may cause immediate and irreparable damage to
            Lafayette Square or other users for which Lafayette Square or such other users would not
            have an adequate remedy at law. Therefore, you agree that, in the event of such
            unauthorized use, Lafayette Square shall be entitled to injunctive and other equitable
            relief without the necessity of proving damages or furnishing a bond or other security.
          </p>
          <p className={cls.body}>
            <span className={cls.inlineLabel}>Force Majeure.</span> Lafayette Square shall not be
            liable for any failure or delay in performing its obligations under these Terms of Use
            arising from causes beyond its reasonable control, including but not limited to acts of
            God, natural disasters, pandemic, fire, flood, earthquakes, war, terrorism, civil
            unrest, government action, power or telecommunications failures, cyberattacks, or other
            events outside of Lafayette Square's reasonable control.
          </p>
        </div>
