...
const sizes = sortCx({
  xxs: {
    strokeWidth: 6,
    radius: 29,
    valueClass: "text-sm font-semibold text-ws-text-primary",
    labelClass: "text-xs font-medium text-ws-text-tertiary",
    halfCircleTextPosition: "absolute bottom-0.5 text-center",
  },
  xs: {
    strokeWidth: 16,
    radius: 72,
    valueClass: "text-display-xs font-semibold text-ws-text-primary",
    labelClass: "text-xs font-medium text-ws-text-tertiary",
    halfCircleTextPosition: "absolute bottom-0.5 text-center",
  },
  sm: {
    strokeWidth: 20,
    radius: 90,
    valueClass: "text-display-sm font-semibold text-ws-text-primary",
    labelClass: "text-xs font-medium text-ws-text-tertiary",
  ...
  md: {
    strokeWidth: 24,
    radius: 108,
    valueClass: "text-display-md font-semibold text-ws-text-primary",
    labelClass: "text-sm font-medium text-ws-text-tertiary",
    halfCircleTextPosition: "absolute bottom-1 text-center",
  },
  lg: {
    strokeWidth: 28,
    radius: 126,
    valueClass: "text-display-lg font-semibold text-ws-text-primary",
    labelClass: "text-sm font-medium text-ws-text-tertiary",
...
export const ProgressBarCircle = ({
  ...
  const textPosition = label ? "absolute text-center" : "absolute text-ws-text-primary";
