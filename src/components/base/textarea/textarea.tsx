...
export const TextAreaBase = ({ className, ...props }: TextAreaBaseProps) => {
  return (
    <AriaTextArea
      ...
      className={state =>
        cx(
          "w-full scroll-py-3 rounded-lg bg-ws-base-white px-3.5 py-3 text-md text-ws-text-primary shadow-xs ring-1 ring-ws-border-primary transition duration-100 ease-linear ring-inset placeholder:text-placeholder autofill:rounded-lg autofill:text-ws-text-primary focus:outline-hidden",
