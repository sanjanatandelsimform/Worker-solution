...
export const TextAreaBase = ({ className, ...props }: TextAreaBaseProps) => {
  return (
    <AriaTextArea
      ...
      className={state =>
        cx(
          "w-full scroll-py-3 rounded-lg bg-ws-white px-3.5 py-3 text-md text-ws-black shadow-xs ring-1 ring-ws-primary-100 transition duration-100 ease-linear ring-inset placeholder:text-placeholder autofill:rounded-lg autofill:text-ws-black focus:outline-hidden",
