...
export const CheckboxBase = ({
  ...
  return (
    <div
      className={cx(
        "relative flex size-4 shrink-0 cursor-pointer appearance-none items-center justify-center rounded bg-ws-white ring-1 ring-ws-primary-100 ring-inset",
        size === "md" && "size-5 rounded-md",
        (isSelected || isIndeterminate) && "bg-blue-700 ring-blue-700 text-ws-white",
    ...
    >
      <svg
        ...
        fill="none"
        className={cx(
          "pointer-events-none absolute h-3 w-2.5 text-ws-white opacity-0 transition-inherit-all",
          size === "md" && "size-3.5",
