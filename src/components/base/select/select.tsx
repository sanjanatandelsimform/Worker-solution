...
const SelectValue = ({
  ...
  return (
    <AriaButton
      ...
      type="button"
      className={cx(
        "relative flex w-full cursor-pointer items-center rounded-lg bg-ws-white shadow-xs ring-1 ring-ws-primary-100 outline-hidden transition duration-100 ease-linear ring-inset text-ws-black-90",
