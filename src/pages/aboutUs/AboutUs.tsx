        ...
        <div className='bg-ws-gray-700 pt-14 pb-19'>
            <div className='flex items-center'>
                ...
                <div className='w-1/2 flex items-center justify-center bg-amber-400'>
                    <div className=' bg-red-500 flex flex-col max-w-md'>
                        <h2 className='text-4xl font-bold text-ws-white'>Introducing BeneStats</h2>
                        <p className='text-base text-ws-white mt-2'>A free assessment tool that delivers tailored benefit recommendations and industry benchmarks based on your company's unique needs.</p>
                    </div>
                </div>
            </div>
        </div>
