    ...
    <div className="w-full rounded-lg border border-ws-border-primary bg-ws-base-white p-6">
      ...
      <div className="flex flex-wrap items-center justify-start gap-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-ws-text-primary">Industry average 44</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="h-3.5 w-3.5 bg-ws-primary-400" />
          <span className="text-sm font-medium text-ws-text-primary">National average 66</span>
        </div>
